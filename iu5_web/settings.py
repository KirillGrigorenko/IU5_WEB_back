"""
Django settings for iu5_web project.
...
SECRET_KEY = 'django-insecure-1^f+i6e!oe(-5+h4v7k=(@1)4pvkee)ir#sp+%x_6k2jozob!k'
...
WSGI_APPLICATION = 'iu5_web.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'group_schedule', # Имя вашей БД. Если вы создали черезе psql или IDE свою базу и хотите использовать его - пропишите его имя здесь
        'USER': 'student',
        'PASSWORD': 'root',
        'HOST': 'localhost',
